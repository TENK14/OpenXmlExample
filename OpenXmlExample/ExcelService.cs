    ...
    public class ExcelService
    {
        ...
        public void CreateExcel(Stream stream)
        {
            using (var spreadsheetDocument = SpreadsheetDocument.Create(stream, SpreadsheetDocumentType.Workbook))
            {
                ...
                var styles = GenerateNumberingStylesheet();
                //var styles = GenerateStylesheet();
                //var styles = GenerateStylesheetOriginal();
                ...
                //    Name = "Details"
                //};
                Sheet sheet = new Sheet() { Id = workbookpart.GetIdOfPart(wsPart), SheetId = sheetId++, Name = "Details" };
        ...
        private Stylesheet GenerateNumberingStylesheetOriginal()
        {
